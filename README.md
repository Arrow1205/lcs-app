...
## Ancienne application du dépôt

L’application Next.js préexistante est conservée avec son ancien accès par code administrateur désactivé dans `legacy/salon-cartes/`. Le CRM Vite est maintenant à la racine ; Vercel doit utiliser le dossier racine, le framework Vite et Node 24.x. Appliquer les migrations SQL nécessaires avant de fusionner cette mise à jour en production.
